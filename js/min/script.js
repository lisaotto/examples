...
var siteURLs = ['lisaot.to', 'localhost', 'grad.lisaot.to', 'staging.lisaot.to'];
...
function loadElements(data) {
	...
	setTimeout(function () {
		...
		banner.imagesLoaded().done(function () {
...
var loadedFromPage, loadedFromElement;
function loadPage(e) {
	if (e) e.preventDefault();
...
},{"./components/header":1,"./components/home":2,"imagesloaded":4,"jquery":7}],4:[function(require,module,exports){
/*!
 * imagesLoaded v3.2.0
...
},{"eventie":5,"wolfy87-eventemitter":6}],5:[function(require,module,exports){
/*!
 * eventie v1.0.6
