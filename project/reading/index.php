...
include('../../includes/header.php'); ?>
    ...
    <div class="intro clearfix outerpadding">
        ...
        <div class="role">
            <h4>My Role</h4>
            <p>I Worked collaboratively with <a href="http://www.saumyakharbanda.com/" target="_blank">Saumya Kharbanda</a> and <a href="http://www.kayleewhite.com/" target="_blank">Kaylee White</a> for the duration of the two week project for CMU MDes IXD Studio on the ideation, video prototype and demonstration.</p>
        </div>
    </div>
    <div class="content outerpadding clearfix">
        ...
        <div class="clearfix">
             <div class="iframe-center"><iframe src="https://player.vimeo.com/video/143089643?title=0&byline=0&portrait=0" width="900" height="507" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> </div>
