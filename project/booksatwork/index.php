...
<main id="projects">
    <div class="banner"> 
        <div class="bannerimg"><img src="<?php echo $cf_url; ?>/img/booksatwork/header_booksatwork.png" alt=""></div>
    ...
    <div class="content outerpadding clearfix">
        <div class="clearfix">
            <img class="halfcolumn" src="<?php echo $cf_url; ?>/img/booksatwork/books-wireframe-old.png">
        ...
        <div class="clearfix">
            <img class="halfcolumn floatright last" src="<?php echo $cf_url; ?>/img/booksatwork/books-bucketing.png">
        ...
        <div class="clearfix">
            <img class="halfcolumn" src="<?php echo $cf_url; ?>/img/booksatwork/books-wireframe-new.png">
        ...
        <div class="clearfix">
            <img class="threecolumn" src="<?php echo $cf_url; ?>/img/booksatwork/booksatwork-home.jpg">
        </div>
        <div class="clearfix">
        ...
        <div class="clearfix">
        <img class="onecolumn" src="<?php echo $cf_url; ?>/img/booksatwork/books-mobile-blog.png">
        <img class="onecolumn" src="<?php echo $cf_url; ?>/img/booksatwork/books-mobile-nav.png">
        <img class="onecolumn last finalblock" src="<?php echo $cf_url; ?>/img/booksatwork/books-mobile-contact.png">
        </div>
