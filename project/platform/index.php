...
<main id="projects">
    <div class="banner"> 
        <div class="bannerimg"><img src="<?php echo $cf_url; ?>/img/platform/platform-header.png"></div>
    ...
    <div class="content outerpadding clearfix">
        <div class="clearfix">
            <img class="twocolumn first" src="<?php echo $cf_url; ?>/img/platform/platform-wireframe1.png">
        ...
        <div class="clearfix">  
             <img class="twocolumn last floatright" src="<?php echo $cf_url; ?>/img/platform/platform-wireframe2.png"> 
        ...
        <div class="clearfix extrapadding">
            <img class="twocolumn last floatright" src="<?php echo $cf_url; ?>/img/platform/newsfromelsewhere.gif">
        ...
        <div class="clearfix extrapadding">
            <img class="twocolumn" src="<?php echo $cf_url; ?>/img/platform/individual.png">
        ...
        <div>
            <img class="onecolumn" src="<?php echo $cf_url; ?>/img/platform/platform-mobile.jpg">
