...
include('../../includes/header.php'); ?>
    ...
    <div class="intro clearfix outerpadding">
        ...
        <div class="role">
        <h4>My Role</h4>
            <p>As the sole designer on the in-house team, I worked with the content and tech team members to define requirements and then created wireframes, UI mocks, and development specifications. I also provided feedback to the external development team to ensure the designs were completed to spec. I also aided with front-end coding. </p>
