...
include('../../includes/header.php'); ?>
    ...
    <div class="navigation">
        <a class="back" href="<?php echo $url; ?>/project/zenoandroid"><span class="icon-arrow-box"></span><span class="title">last project</span></a>
    ...
    <div class="content outerpadding clearfix">
        ...
        <div class="clearfix">
            ...
            <p class="threecolumn finalblock">Live.Zeno is still being beta tested and undergoing user testing to determine which features are most desirable to the small talk show broadcasters. More to come as the platform develops.</p>
        </div>
    </div>
