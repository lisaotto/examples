...
?>
<!DOCTYPE html>
<!--[if lt IE 7]>      <html class="preload no-js oldie lt-ie9 lt-ie8 lt-ie7"> <![endif]-->
<!--[if IE 7]>         <html class="preload no-js oldie lt-ie9 lt-ie8"> <![endif]-->
<!--[if IE 8]>         <html class="preload no-js oldie lt-ie9"> <![endif]-->
<!--[if IE 9]>         <html class="preload no-js oldie"> <![endif]-->
<!--[if gt IE 8]><!--> <html class="preload no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
