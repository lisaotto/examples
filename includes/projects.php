...
function the_navigation($url, $slug) { ?>
    <div class="navigation">
        ...
        <?php if ($prev) { ?>
            <a class="back" href="<?= $url; ?>/project/<?= $prev; ?>"><span class="icon-arrow-box"></span><span class="title">last project</span></a>
        <?php }
        if ($next) { ?>
        <a class="next" href="<?= $url; ?>/project/<?= $next; ?>"><span class="title">next project</span><span class="icon-arrow-box"></span></a>
        <?php } ?>
        <div class="bar"></div>
    </div>
    <?php
